...
?>
					<?php
						...
						$welcome_view = "SELECT * FROM employee, travel_ordr, department, finance, vp_academic
									WHERE employee.emp_id = travel_ordr.emp_id 
									AND employee.id_dept = department.id_dept 
									AND travel_ordr.vp_finance = finance.vp_finance 
									AND travel_ordr.vp_acad = vp_academic.vp_acad
									AND finance.vp_finance = '2' AND vp_academic.vp_acad = '1'";
