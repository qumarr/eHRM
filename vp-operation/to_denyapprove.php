		...
		<div id="dvContents">
			...
			<?php include("background_print.php");?>
				...
				?>
						...
						<div class="col-md-6 col-md-offset-3">
								<div class="panel panel-default">
									<div class="panel-body">
										...
										Full Name: &nbsp <strong><?php echo $rec['emp_fname'];?> <style="margin-left: 20px;"/><?php echo $rec['emp_lname'];?><style="margin-left: 20px;"/> <?php echo $rec['emp_mname'];?></strong> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Designation: &nbsp <strong><?php echo $rec['to_desig'];?></strong><hr/>
								...
								<div class="panel panel-success">
									<div class="panel-heading">ITINERARY OF TRAVEL</div>
										<div class="panel-body">
										Deployment: &nbsp <strong><?php echo $rec['to_etd']; ?></strong>Arrival: &nbsp <strong><?php echo $rec['to_eta']; ?></strong><hr/>
					...
					<div class="col-md-9">
						<a href="to_approveto.php?id=<?php echo $rec['to_id'];?>"><input type='button' value='Approve' class='btn btn-success'/></a>
						<a href = "to_approval_deny.php"><input type="button" value="Back" name="cancel" class="btn btn-default"/></a>
