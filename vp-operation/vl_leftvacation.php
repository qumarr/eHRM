			...
			<br/>
					<div class="col-md-12" style="margin-top:40px">
						<div class="col-md-4 col-md-offset-4">
										...
										Total Days Leave: &nbsp <strong><?php echo $recc['nodays'];?></strong> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Days Left: &nbsp <strong><?php echo "$value3";?></strong><hr/>
						</div>
						<div class="col-md-4 col-md-offset-4">
