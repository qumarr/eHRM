								...
								<div class="alert alert-success">
								   ...
								   <span class="glyphicon glyphicon-ok"></span> <strong>Done!</strong>
									...
									<div class="col-md-offset-9">
										<a href="vl_view.php"><button type="button" class="btn btn-success">Continue</button></a>
									</div>
									</p>
								</div>
							</div>';
						...
						<div class="panel-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-8">
								...
								<a href="to_apply.php"><input type="button" value="Cancel" class="btn btn-default"></a>
							  </div>
							</div>
