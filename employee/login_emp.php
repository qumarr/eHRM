  ...
  <div class="container-fluid">
	<?php include("../drop.php");?>
		<?php
			...
			$UserName=$_POST['emp_lname'];//variable ang $Username kag ang $_POST['UserName'] ay value sang textbox nga UserName
			$Password=$_POST['id_emp'];//variable ang $Username kag ang $_POST['Password'] ay value sang textbox nga Password
			$result=mysql_query("select * from employee where emp_lname='$UserName' and id_emp='$Password' and stat='1'")or die (mysql_error());//query sang database 
			...
			$_SESSION['emp_id']=$row['emp_id'];//kwaon ang id sang may tyakto nga username kag password ang ibotang sa $_SESSION['member_id']
			header('location:home.php?id='.$row['emp_id'].'');
					...
					<div class="panel-body">
						<form method="post" class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" id="emp_lname" name="emp_lname" class="form-control" data-toggle="tooltip" data-placement="right" title="Last Name" placeholder="Username" required>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-1 control-label"></label>
								<div class="col-sm-10">
									<input type="password" id="id_emp" name="id_emp" class="form-control" data-toggle="tooltip" data-placement="right" title="Employee ID" placeholder="Password" required>
								</div>
							</div>
